...
class ControllerProductProduct extends Controller {
	...
	public function update(){
		...
		$options = explode(",", $this->request->post['options']);
		...
		$product_price = 0;
			...
			foreach ($this->model_catalog_product->getProductOptions($this->request->post['product_id']) as $option) {
				...
				foreach ($option['product_option_value'] as $option_value) {
					if(!in_array($option_value['product_option_value_id'], $options)){
						continue;
					}
		...
		$price = $this->currency->format($this->tax->calculate($price, $product_info['tax_class_id'], $this->config->get('config_tax') ? 'P' : false));
