...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		$data['text_buketbase'] = "База цветов";
		$data['text_buketgroup'] = "Группы цветов";
		...
		$data['buketbase'] = $this->url->link('extension/buketbase', 'token=' . $this->session->data['token'], 'SSL');
		$data['buket_groups'] = $this->url->link('extension/buket_group', 'token=' . $this->session->data['token'], 'SSL');
