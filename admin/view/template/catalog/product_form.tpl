        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-price"><?php echo $special_entry_price; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="special_price" value="<?php echo $special_price; ?>" placeholder="<?php echo $special_entry_price; ?>" id="input-price" class="form-control" />
                </div>
              </div>
            ...
            <div class="tab-pane" id="tab-links">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-flowers"><span data-toggle="tooltip" title="Цветы">Состав</span></label>
                <div class="col-sm-10">
                  <input type="text" name="flowers" value="" placeholder="" id="input-flowers" class="form-control" />
                  <div id="product-flowers" class="well well-sm" style="height: 150px; overflow: auto;">
                    <?php foreach ($flowers as $item) { ?>
                    <div id="product-flowers<?php echo $item['id']; ?>"><i class="fa fa-minus-circle"></i> <?php echo $item['name']; ?>
                    <input type="number" name="fquantity[<?php echo $item['id']; ?>][]" value="<?php echo $item['quantity']; ?>" min="0">
                      <input type="hidden" name="flowers[]" value="<?php echo $item['id']; ?>" />
                    </div>
                    <?php } ?>
                  </div>
                </div>
...
// Flowers
$('input[name=\'flowers\']').autocomplete({
  'source': function(request, response) {
    $.ajax({
  ...
  'select': function(item) {
    $('input[name=\'flowers\']').val('');
    
    $('#product-flowers' + item['value']).remove();
    
    $('#product-flowers').append('<div id="product-flowers' + item['value'] + '"><i class="fa fa-minus-circle"></i> ' + item['label'] + '<input type="number" name="fquantity['+item['value']+'][]" value="" min="0"><input type="hidden" name="flowers[]" value="' + item['value'] + '" /></div>'); 
  }
});

$('#product-flowers').delegate('.fa-minus-circle', 'click', function() {
	$(this).parent().remove();
});
