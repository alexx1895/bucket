            ...
            <tbody>
              ...
              <tr id="module-row<?php echo $module_row; ?>">
                ...
                <td class="text-left"><select name="layout_module[<?php echo $module_row; ?>][position]" class="form-control">
					...
					<?php if ($layout_module['position'] == 'content_news') { ?>
                    <option value="content_news" selected="selected"><?php echo $text_news; ?></option>
                    <?php } else { ?>
                    <option value="content_news"><?php echo $text_news; ?></option>
                    <?php } ?>
...
function addModule() {
	...
	html += '    <option value="content_news"><?php echo $text_news; ?></option>';
