...
class ModelSaleCustomer extends Model {
	...
	public function getCustomersMail(){
		$query = $this->db->query("SELECT * FROM `" . DB_PREFIX . "mails` WHERE 1");

		return $query->rows;
	}

	public function getCustomersMailTotal(){
		$query = $this->db->query("SELECT COUNT(*) AS total FROM `" . DB_PREFIX . "mails` WHERE 1");
